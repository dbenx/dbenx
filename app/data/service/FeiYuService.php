...
class FeiYuService extends Service
{
    // Server address
    public $host = '';
    // Data fetch route
    ...
    public function pushData($data)
    {
        if(!isset($data['clue_convert_state']) || !isset($data['clue_id'])){
           ...
           // $this->error("Upload data is missing the necessary parameters");
        }
        if(!is_numeric($data['clue_convert_state'])){
          //  $this->error("'clue_convert_state' must be a numeric type");
        }
